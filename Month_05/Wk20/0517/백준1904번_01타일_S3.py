...
2(2가지)    = 11, 00
3(3가지)    = 100, 001, 111
4(5가지)    = 0000, 0011, 1001, 1100, 1111
5(8가지)    = 00001, 00100, 10000, 00111, 10011, 11001, 11100, 11111
6(13가지)   = 000000, 000011, 001001, 001100, 100100, 110000, 100001, 001111, 100111, 110011, 111001, 111100, 111111

점화식 : n이 3까지는 규칙X, 4부터는 d[i] = d[i-1] + d[i-2]
'''
n = int(input())
